...
abstract class Categorylist implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Map\\CategorylistTableMap';
    ...
    /**
     * Initializes internal state of Base\Categorylist object.
     */
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Categorylist'), 0, $e);
        }
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of \Categorylist (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Categorylist Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
        ...
        if (null === $this->collCategories || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                if (null === $this->collCategories) {
                    ...
                    $collCategories->setModel('\Category');
