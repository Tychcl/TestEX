 ...
 *
 * @method     \EventinfoQuery|\TeacherQuery|\EventroleQuery|\StudentQuery|\EventawarddegreeQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class EventQuery extends ModelCriteria
{
     ...
     *
     * @param \Eventinfo|ObjectCollection $eventinfo The related object(s) to use as filter
     * @param string|null $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    /**
     * Filter the query by a related \Eventrole object
     *
     * @param \Eventrole|ObjectCollection $eventrole The related object(s) to use as filter
     * @param string|null $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    public function filterByEventrole($eventrole, ?string $comparison = null)
    {
        if ($eventrole instanceof \Eventrole) {
            ...
            throw new PropelException('filterByEventrole() only accepts arguments of type \Eventrole or Collection');
        }
    }
     ...
     * @param string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \EventroleQuery A secondary query class using the current class as primary query
     */
    public function useEventroleQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinEventrole($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Eventrole', '\EventroleQuery');
    }

    /**
     * Use the Eventrole relation Eventrole object
     *
     * @param callable(\EventroleQuery):\EventroleQuery $callable A function working on the related query
     *
     * @param string|null $relationAlias optional alias for the relation
     *
     * @param string|null $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     ...
     * @param string|null $queryClass Allows to use a custom query class for the exists query, like ExtendedBookQuery::class
     *
     * @return \EventroleQuery The inner query object of the NOT EXISTS statement
     */
     ...
     * @param string $typeOfIn Criteria::IN or Criteria::NOT_IN
     *
     * @return \EventroleQuery The inner query object of the IN statement
     */
     ...
     * @param string|null $queryClass Allows to use a custom query class for the NOT IN query, like ExtendedBookQuery::class
     *
     * @return \EventroleQuery The inner query object of the NOT IN statement
     */
     ...
     * @param string $typeOfIn Criteria::IN or Criteria::NOT_IN
     *
     * @return \StudentQuery The inner query object of the IN statement
     */
     ...
     * @param string|null $queryClass Allows to use a custom query class for the NOT IN query, like ExtendedBookQuery::class
     *
     * @return \StudentQuery The inner query object of the NOT IN statement
     */
    ...
    /**
     * Filter the query by a related \Eventawarddegree object
     *
     * @param \Eventawarddegree|ObjectCollection $eventawarddegree The related object(s) to use as filter
     * @param string|null $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($eventawarddegree instanceof \Eventawarddegree) {
            return $this
            ...
            throw new PropelException('filterByEventawarddegree() only accepts arguments of type \Eventawarddegree or Collection');
        }
    }
     ...
     * @param string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \EventawarddegreeQuery A secondary query class using the current class as primary query
     */
    public function useEventawarddegreeQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'Eventawarddegree', '\EventawarddegreeQuery');
    }

    /**
     * Use the Eventawarddegree relation Eventawarddegree object
     *
     * @param callable(\EventawarddegreeQuery):\EventawarddegreeQuery $callable A function working on the related query
     *
     * @param string|null $relationAlias optional alias for the relation
     *
     * @param string|null $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     ...
     * @param string $typeOfExists Either ExistsQueryCriterion::TYPE_EXISTS or ExistsQueryCriterion::TYPE_NOT_EXISTS
     *
     * @return \EventawarddegreeQuery The inner query object of the EXISTS statement
     */
    public function useEventawarddegreeExistsQuery($modelAlias = null, $queryClass = null, $typeOfExists = 'EXISTS')
    {
        /** @var $q \EventawarddegreeQuery */
     ...
     * @param string|null $queryClass Allows to use a custom query class for the exists query, like ExtendedBookQuery::class
     *
     * @return \EventawarddegreeQuery The inner query object of the NOT EXISTS statement
     */
     ...
     * @param string $typeOfIn Criteria::IN or Criteria::NOT_IN
     *
     * @return \EventawarddegreeQuery The inner query object of the IN statement
     */
     ...
     * @param string|null $queryClass Allows to use a custom query class for the NOT IN query, like ExtendedBookQuery::class
     *
     * @return \EventawarddegreeQuery The inner query object of the NOT IN statement
     */
