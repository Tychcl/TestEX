...
/**
 * Base class that represents a row from the 'eventAwardDegree' table.
 *
 * Степени награждения
 *
 * @package    propel.generator..Base
 */
abstract class Eventawarddegree implements ActiveRecordInterface
{
    /**
     * TableMap class name
     *
     * @var string
     */
    public const TABLE_MAP = '\\Map\\EventawarddegreeTableMap';
    ...
    /**
     * Initializes internal state of Base\Eventawarddegree object.
     */
    ...
    /**
     * Compares this with another <code>Eventawarddegree</code> instance.  If
     * <code>obj</code> is an instance of <code>Eventawarddegree</code>, delegates to
     * <code>equals(Eventawarddegree)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[EventawarddegreeTableMap::COL_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[EventawarddegreeTableMap::COL_NAME] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : EventawarddegreeTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : EventawarddegreeTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = EventawarddegreeTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Eventawarddegree'), 0, $e);
        }
    }
    ...
    public function reload(bool $deep = false, ?ConnectionInterface $con = null): void
    {
        ...
        $dataFetcher = ChildEventawarddegreeQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws \Propel\Runtime\Exception\PropelException
     * @see Eventawarddegree::setDeleted()
     * @see Eventawarddegree::isDeleted()
     */
    public function delete(?ConnectionInterface $con = null): void
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildEventawarddegreeQuery::create()
    ...
    public function save(?ConnectionInterface $con = null): int
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                EventawarddegreeTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        $this->modifiedColumns[EventawarddegreeTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . EventawarddegreeTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(EventawarddegreeTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(EventawarddegreeTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }

        $sql = sprintf(
            'INSERT INTO eventAwardDegree (%s) VALUES (%s)',
    ...
    {
        $pos = EventawarddegreeTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Eventawarddegree'][$this->hashCode()])) {
            return ['*RECURSION*'];
        }
        $alreadyDumpedObjects['Eventawarddegree'][$this->hashCode()] = true;
        $keys = EventawarddegreeTableMap::getFieldNames($keyType);
        $result = [
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
        ];
    ...
    {
        $criteria = new Criteria(EventawarddegreeTableMap::DATABASE_NAME);

        if ($this->isColumnModified(EventawarddegreeTableMap::COL_ID)) {
            $criteria->add(EventawarddegreeTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(EventawarddegreeTableMap::COL_NAME)) {
            $criteria->add(EventawarddegreeTableMap::COL_NAME, $this->name);
        }
    ...
    {
        $criteria = ChildEventawarddegreeQuery::create();
        $criteria->add(EventawarddegreeTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of \Eventawarddegree (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Eventawarddegree Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
     ...
     * If this ChildEventawarddegree is new, it will return
    ...
    public function setEvents(Collection $events, ?ConnectionInterface $con = null)
    {
        ...
        foreach ($eventsToDelete as $eventRemoved) {
            $eventRemoved->setEventawarddegree(null);
        }
    ...
    protected function doAddEvent(ChildEvent $event): void
    {
        ...
        $event->setEventawarddegree($this);
    }
    ...
    public function removeEvent(ChildEvent $event)
    {
        if ($this->getEvents()->contains($event)) {
            ...
            $event->setEventawarddegree(null);
        }
     ...
     * Otherwise if this Eventawarddegree is new, it will return
     * an empty collection; or if this Eventawarddegree has previously
     * been saved, it will retrieve related Events from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Eventawarddegree.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param ConnectionInterface $con optional connection object
    ...
    {
        return (string) $this->exportTo(EventawarddegreeTableMap::DEFAULT_STRING_FORMAT);
    }
