...
abstract class Eventrole implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Map\\EventroleTableMap';
    ...
    /**
     * Initializes internal state of Base\Eventrole object.
     */
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Eventrole'), 0, $e);
        }
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of \Eventrole (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Eventrole Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
