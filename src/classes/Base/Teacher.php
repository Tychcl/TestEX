...
abstract class Teacher implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Map\\TeacherTableMap';
    ...
    /**
     * The value for the midname field.
     * Отчество
     * @var        string
     */
    protected $midname;
    ...
    /**
     * Initializes internal state of Base\Teacher object.
     * @see applyDefaults()
     */
    ...
    public function setSurname($v)
    {
        ...
        if ($this->surname !== $v) {
            $this->surname = $v;
            $this->modifiedColumns[TeacherTableMap::COL_SURNAME] = true;
        }
    ...
    /**
     * Set the value of [midname] column.
     * Отчество
     * @param string $v New value
     * @return $this The current object (for fluent API support)
     */
    public function setMidname($v)
    {
        ...
        if ($this->midname !== $v) {
            $this->midname = $v;
            $this->modifiedColumns[TeacherTableMap::COL_MIDNAME] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : TeacherTableMap::translateFieldName('Surname', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : TeacherTableMap::translateFieldName('Midname', TableMap::TYPE_PHPNAME, $indexType)];
            $this->midname = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : TeacherTableMap::translateFieldName('Login', TableMap::TYPE_PHPNAME, $indexType)];
            $this->login = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : TeacherTableMap::translateFieldName('Password', TableMap::TYPE_PHPNAME, $indexType)];
            $this->password = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : TeacherTableMap::translateFieldName('Roleid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->roleid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : TeacherTableMap::translateFieldName('Needupdskill', TableMap::TYPE_PHPNAME, $indexType)];
            $this->needupdskill = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : TeacherTableMap::translateFieldName('Canupdcategory', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(TeacherTableMap::COL_SURNAME)) {
            $modifiedColumns[':p' . $index++]  = 'surname';
        }
        if ($this->isColumnModified(TeacherTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(TeacherTableMap::COL_MIDNAME)) {
            $modifiedColumns[':p' . $index++]  = 'midname';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'name':
                        ...
                        break;
                    case 'midname':
                        $stmt->bindValue($identifier, $this->midname, PDO::PARAM_STR);
    ...
    public function toArray(string $keyType = TableMap::TYPE_PHPNAME, bool $includeLazyLoadColumns = true, array $alreadyDumpedObjects = [], bool $includeForeignObjects = false): array
    {
        ...
        $result = [
            ...
            $keys[7] => $this->getNeedupdskill(),
            $keys[8] => $this->getCanupdcategory(),
        ];
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setSurname($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setName($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setMidname($arr[$keys[3]]);
        }
        ...
        if (array_key_exists($keys[7], $arr)) {
            $this->setNeedupdskill($arr[$keys[7]]);
        }
        if (array_key_exists($keys[8], $arr)) {
            $this->setCanupdcategory($arr[$keys[8]]);
        }
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(TeacherTableMap::COL_SURNAME)) {
            $criteria->add(TeacherTableMap::COL_SURNAME, $this->surname);
        }
        if ($this->isColumnModified(TeacherTableMap::COL_NAME)) {
            $criteria->add(TeacherTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(TeacherTableMap::COL_MIDNAME)) {
            $criteria->add(TeacherTableMap::COL_MIDNAME, $this->midname);
        }
        if ($this->isColumnModified(TeacherTableMap::COL_LOGIN)) {
    ...
    public function copyInto(object $copyObj, bool $deepCopy = false, bool $makeNew = true): void
    {
        ...
        $copyObj->setMidname($this->getMidname());
