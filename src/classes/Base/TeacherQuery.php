 ...
 * @method     ChildTeacherQuery orderBySurname($order = Criteria::ASC) Order by the surname column
 * @method     ChildTeacherQuery orderByName($order = Criteria::ASC) Order by the name column
 * @method     ChildTeacherQuery orderByMidname($order = Criteria::ASC) Order by the midname column
 ...
 * @method     ChildTeacherQuery groupBySurname() Group by the surname column
 * @method     ChildTeacherQuery groupByName() Group by the name column
 * @method     ChildTeacherQuery groupByMidname() Group by the midname column
 ...
 *
 * @method     \UserroleQuery|\CategoryQuery|\EventQuery|\SkillQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildTeacher|null findOneBySurname(string $surname) Return the first ChildTeacher filtered by the surname column
 * @method     ChildTeacher|null findOneByName(string $name) Return the first ChildTeacher filtered by the name column
 * @method     ChildTeacher|null findOneByMidname(string $midname) Return the first ChildTeacher filtered by the midname column
 ...
 * @method     ChildTeacher requireOneBySurname(string $surname) Return the first ChildTeacher filtered by the surname column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildTeacher requireOneByMidname(string $midname) Return the first ChildTeacher filtered by the midname column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildTeacher[]|Collection findBySurname(string|array<string> $surname) Return ChildTeacher objects filtered by the surname column
 * @psalm-method Collection&\Traversable<ChildTeacher> findBySurname(string|array<string> $surname) Return ChildTeacher objects filtered by the surname column
 * @method     ChildTeacher[]|Collection findByName(string|array<string> $name) Return ChildTeacher objects filtered by the name column
 * @psalm-method Collection&\Traversable<ChildTeacher> findByName(string|array<string> $name) Return ChildTeacher objects filtered by the name column
 * @method     ChildTeacher[]|Collection findByMidname(string|array<string> $midname) Return ChildTeacher objects filtered by the midname column
 * @psalm-method Collection&\Traversable<ChildTeacher> findByMidname(string|array<string> $midname) Return ChildTeacher objects filtered by the midname column
...
abstract class TeacherQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'default', $modelName = '\\Teacher', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, surname, name, midname, login, password, roleId, needUpdSkill, canUpdCategory FROM teacher WHERE id = :p0';
        try {
    ...
    public function filterBySurname($surname = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(TeacherTableMap::COL_SURNAME, $surname, $comparison);
    ...
    public function filterByName($name = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(TeacherTableMap::COL_NAME, $name, $comparison);
    ...
    public function filterByMidname($midname = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(TeacherTableMap::COL_MIDNAME, $midname, $comparison);
     ...
     * Use the Userrole relation Userrole object
     *
     * @param callable(\UserroleQuery):\UserroleQuery $callable A function working on the related query
     *
     * @param string|null $relationAlias optional alias for the relation
     *
     * @param string|null $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     ...
     *
     * @return \UserroleQuery The inner query object of the EXISTS statement
     */
     ...
     * @param string|null $queryClass Allows to use a custom query class for the exists query, like ExtendedBookQuery::class
     *
     * @return \UserroleQuery The inner query object of the NOT EXISTS statement
     */
     ...
     *
     * @return \UserroleQuery The inner query object of the IN statement
     */
     ...
     *
     * @return \UserroleQuery The inner query object of the NOT IN statement
     */
     ...
     *
     * @param \Skill|ObjectCollection $skill the related object to use as filter
     * @param string|null $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return $this The current query, for fluid interface
     */
    public function filterBySkill($skill, ?string $comparison = null)
    {
        if ($skill instanceof \Skill) {
            ...
            throw new PropelException('filterBySkill() only accepts arguments of type \Skill or Collection');
        }
    }
     ...
     * @param string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \SkillQuery A secondary query class using the current class as primary query
     */
    public function useSkillQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinSkill($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Skill', '\SkillQuery');
    }

    /**
     * Use the Skill relation Skill object
     *
     * @param callable(\SkillQuery):\SkillQuery $callable A function working on the related query
     *
     * @param string|null $relationAlias optional alias for the relation
     *
     * @param string|null $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     ...
     * @param string $typeOfExists Either ExistsQueryCriterion::TYPE_EXISTS or ExistsQueryCriterion::TYPE_NOT_EXISTS
     *
     * @return \SkillQuery The inner query object of the EXISTS statement
     */
     ...
     * @param string|null $queryClass Allows to use a custom query class for the exists query, like ExtendedBookQuery::class
     *
     * @return \SkillQuery The inner query object of the NOT EXISTS statement
     */
     ...
     * @param string $typeOfIn Criteria::IN or Criteria::NOT_IN
     *
     * @return \SkillQuery The inner query object of the IN statement
     */
     ...
     * @param string|null $queryClass Allows to use a custom query class for the NOT IN query, like ExtendedBookQuery::class
     *
     * @return \SkillQuery The inner query object of the NOT IN statement
     */
