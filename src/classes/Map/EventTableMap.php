...
class EventTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = '.Map.EventTableMap';
     ...
     */
    public const OM_CLASS = '\\Event';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'Event';
    ...
    {
        $this->addRelation('Eventinfo', '\\Eventinfo', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':infoId',
    1 => ':id',
        ...
        $this->addRelation('Teacher', '\\Teacher', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':teacherId',
    1 => ':id',
        ...
        $this->addRelation('Eventrole', '\\Eventrole', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':teacherRoleId',
    1 => ':id',
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('Eventawarddegree', '\\Eventawarddegree', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':awardId',
    1 => ':id',
