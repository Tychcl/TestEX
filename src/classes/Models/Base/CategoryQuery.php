 ...
 *
 * @method     \Models\TeacherQuery|\Models\CategorylistQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class CategoryQuery extends ModelCriteria
{
    ...
    /**
     * Filter the query by a related \Models\Categorylist object
     *
     * @param \Models\Categorylist|ObjectCollection $categorylist The related object(s) to use as filter
     * @param string|null $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($categorylist instanceof \Models\Categorylist) {
            return $this
            ...
            throw new PropelException('filterByCategorylist() only accepts arguments of type \Models\Categorylist or Collection');
        }
    }
     ...
     * @param string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \Models\CategorylistQuery A secondary query class using the current class as primary query
     */
    public function useCategorylistQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'Categorylist', '\Models\CategorylistQuery');
    }

    /**
     * Use the Categorylist relation Categorylist object
     *
     * @param callable(\Models\CategorylistQuery):\Models\CategorylistQuery $callable A function working on the related query
     *
     * @param string|null $relationAlias optional alias for the relation
     *
     * @param string|null $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     ...
     * @param string $typeOfExists Either ExistsQueryCriterion::TYPE_EXISTS or ExistsQueryCriterion::TYPE_NOT_EXISTS
     *
     * @return \Models\CategorylistQuery The inner query object of the EXISTS statement
     */
    public function useCategorylistExistsQuery($modelAlias = null, $queryClass = null, $typeOfExists = 'EXISTS')
    {
        /** @var $q \Models\CategorylistQuery */
     ...
     * @param string|null $queryClass Allows to use a custom query class for the exists query, like ExtendedBookQuery::class
     *
     * @return \Models\CategorylistQuery The inner query object of the NOT EXISTS statement
     */
     ...
     * @param string $typeOfIn Criteria::IN or Criteria::NOT_IN
     *
     * @return \Models\CategorylistQuery The inner query object of the IN statement
     */
     ...
     * @param string|null $queryClass Allows to use a custom query class for the NOT IN query, like ExtendedBookQuery::class
     *
     * @return \Models\CategorylistQuery The inner query object of the NOT IN statement
     */
