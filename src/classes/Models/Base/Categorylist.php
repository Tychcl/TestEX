...
/**
 * Base class that represents a row from the 'categoryList' table.
 *
 *
 *
 * @package    propel.generator.Models.Base
 */
abstract class Categorylist implements ActiveRecordInterface
{
    /**
     * TableMap class name
     *
     * @var string
     */
    public const TABLE_MAP = '\\Models\\Map\\CategorylistTableMap';
    ...
    /**
     * Initializes internal state of Models\Base\Categorylist object.
     */
    ...
    /**
     * Compares this with another <code>Categorylist</code> instance.  If
     * <code>obj</code> is an instance of <code>Categorylist</code>, delegates to
     * <code>equals(Categorylist)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[CategorylistTableMap::COL_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[CategorylistTableMap::COL_NAME] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CategorylistTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CategorylistTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = CategorylistTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Models\\Categorylist'), 0, $e);
        }
    }
    ...
    public function reload(bool $deep = false, ?ConnectionInterface $con = null): void
    {
        ...
        $dataFetcher = ChildCategorylistQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws \Propel\Runtime\Exception\PropelException
     * @see Categorylist::setDeleted()
     * @see Categorylist::isDeleted()
     */
    public function delete(?ConnectionInterface $con = null): void
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildCategorylistQuery::create()
    ...
    public function save(?ConnectionInterface $con = null): int
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CategorylistTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        $this->modifiedColumns[CategorylistTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . CategorylistTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(CategorylistTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(CategorylistTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }

        $sql = sprintf(
            'INSERT INTO categoryList (%s) VALUES (%s)',
    ...
    {
        $pos = CategorylistTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Categorylist'][$this->hashCode()])) {
            return ['*RECURSION*'];
        }
        $alreadyDumpedObjects['Categorylist'][$this->hashCode()] = true;
        $keys = CategorylistTableMap::getFieldNames($keyType);
        $result = [
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
        ];
    ...
    {
        $criteria = new Criteria(CategorylistTableMap::DATABASE_NAME);

        if ($this->isColumnModified(CategorylistTableMap::COL_ID)) {
            $criteria->add(CategorylistTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(CategorylistTableMap::COL_NAME)) {
            $criteria->add(CategorylistTableMap::COL_NAME, $this->name);
        }
    ...
    {
        $criteria = ChildCategorylistQuery::create();
        $criteria->add(CategorylistTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of \Models\Categorylist (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Models\Categorylist Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
     ...
     * If this ChildCategorylist is new, it will return
    ...
    public function setCategories(Collection $categories, ?ConnectionInterface $con = null)
    {
        ...
        foreach ($categoriesToDelete as $categoryRemoved) {
            $categoryRemoved->setCategorylist(null);
        }
     ...
     * Otherwise if this Categorylist is new, it will return
     * an empty collection; or if this Categorylist has previously
     * been saved, it will retrieve related Categories from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Categorylist.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param ConnectionInterface $con optional connection object
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildCategory}> List of ChildCategory objects
     */
    public function getCategoriesJoinTeacher(?Criteria $criteria = null, ?ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildCategoryQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(CategorylistTableMap::DEFAULT_STRING_FORMAT);
    }
