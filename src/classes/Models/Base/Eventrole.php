...
use Models\Map\EventroleTableMap;
...
/**
 * Base class that represents a row from the 'eventRole' table.
 *
 * Роль участия
 *
 * @package    propel.generator.Models.Base
 */
abstract class Eventrole implements ActiveRecordInterface
{
    /**
     * TableMap class name
     *
     * @var string
     */
    public const TABLE_MAP = '\\Models\\Map\\EventroleTableMap';
    ...
    /**
     * Initializes internal state of Models\Base\Eventrole object.
     */
    ...
    /**
     * Compares this with another <code>Eventrole</code> instance.  If
     * <code>obj</code> is an instance of <code>Eventrole</code>, delegates to
     * <code>equals(Eventrole)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[EventroleTableMap::COL_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[EventroleTableMap::COL_NAME] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : EventroleTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : EventroleTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = EventroleTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Models\\Eventrole'), 0, $e);
        }
    }
    ...
    public function reload(bool $deep = false, ?ConnectionInterface $con = null): void
    {
        ...
        $dataFetcher = ChildEventroleQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws \Propel\Runtime\Exception\PropelException
     * @see Eventrole::setDeleted()
     * @see Eventrole::isDeleted()
     */
    public function delete(?ConnectionInterface $con = null): void
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildEventroleQuery::create()
    ...
    public function save(?ConnectionInterface $con = null): int
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                EventroleTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        $this->modifiedColumns[EventroleTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . EventroleTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(EventroleTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(EventroleTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }

        $sql = sprintf(
            'INSERT INTO eventRole (%s) VALUES (%s)',
    ...
    {
        $pos = EventroleTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Eventrole'][$this->hashCode()])) {
            return ['*RECURSION*'];
        }
        $alreadyDumpedObjects['Eventrole'][$this->hashCode()] = true;
        $keys = EventroleTableMap::getFieldNames($keyType);
        $result = [
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
        ];
    ...
    {
        $criteria = new Criteria(EventroleTableMap::DATABASE_NAME);

        if ($this->isColumnModified(EventroleTableMap::COL_ID)) {
            $criteria->add(EventroleTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(EventroleTableMap::COL_NAME)) {
            $criteria->add(EventroleTableMap::COL_NAME, $this->name);
        }
    ...
    {
        $criteria = ChildEventroleQuery::create();
        $criteria->add(EventroleTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of \Models\Eventrole (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Models\Eventrole Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
     ...
     * If this ChildEventrole is new, it will return
    ...
    public function setEvents(Collection $events, ?ConnectionInterface $con = null)
    {
        ...
        foreach ($eventsToDelete as $eventRemoved) {
            $eventRemoved->setEventrole(null);
        }
     ...
     * Otherwise if this Eventrole is new, it will return
     * an empty collection; or if this Eventrole has previously
     * been saved, it will retrieve related Events from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Eventrole.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param ConnectionInterface $con optional connection object
    ...
    {
        return (string) $this->exportTo(EventroleTableMap::DEFAULT_STRING_FORMAT);
    }
