...
class UserroleTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'Models.Map.UserroleTableMap';
     ...
     */
    public const TABLE_NAME = 'userRole';
     ...
     */
    public const OM_CLASS = '\\Models\\Userrole';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'Models.Userrole';
     ...
     */
    public const COL_ID = 'userRole.id';

    /**
     * the column name for the name field
     */
    public const COL_NAME = 'userRole.name';
    ...
    protected static $fieldNames = [
        ...
        self::TYPE_COLNAME       => [UserroleTableMap::COL_ID, UserroleTableMap::COL_NAME, ],
    ...
    protected static $fieldKeys = [
        ...
        self::TYPE_COLNAME       => [UserroleTableMap::COL_ID => 0, UserroleTableMap::COL_NAME => 1, ],
    ...
    public function initialize(): void
    {
        ...
        $this->setClassName('\\Models\\Userrole');
    ...
    {
        $this->addRelation('Teacher', '\\Models\\Teacher', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':roleId',
    1 => ':id',
  ),
), 'RESTRICT', 'CASCADE', 'Teachers', false);
    }
     ...
     */
     public static function doDelete($values, ?ConnectionInterface $con = null): int
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Models\Userrole) { // it's a model object
