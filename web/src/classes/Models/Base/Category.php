...
abstract class Category implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Models\\Map\\CategoryTableMap';
    ...
    public function setTeacherid($v)
    {
        ...
        if ($this->teacherid !== $v) {
            $this->teacherid = $v;
            $this->modifiedColumns[CategoryTableMap::COL_TEACHERID] = true;
        }
    ...
    /**
     * Set the value of [organ] column.
     * Орган издавший приказ
     * @param string $v New value
     * @return $this The current object (for fluent API support)
     */
    public function setOrgan($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->organ !== $v) {
            $this->organ = $v;
            $this->modifiedColumns[CategoryTableMap::COL_ORGAN] = true;
        }
    ...
    public function setDate($v)
    {
        ...
        if ($this->date !== null || $dt !== null) {
            if ($this->date === null || $dt === null || $dt->format("Y-m-d") !== $this->date->format("Y-m-d")) {
                ...
                $this->modifiedColumns[CategoryTableMap::COL_DATE] = true;
            }
    ...
    public function setNum($v)
    {
        ...
        if ($this->num !== $v) {
            $this->num = $v;
            $this->modifiedColumns[CategoryTableMap::COL_NUM] = true;
        }
    ...
    public function setPost($v)
    {
        ...
        if ($this->post !== $v) {
            $this->post = $v;
            $this->modifiedColumns[CategoryTableMap::COL_POST] = true;
        }
    ...
    public function setPlace($v)
    {
        ...
        if ($this->place !== $v) {
            $this->place = $v;
            $this->modifiedColumns[CategoryTableMap::COL_PLACE] = true;
        }
    ...
    public function setCategoryid($v)
    {
        ...
        if ($this->categoryid !== $v) {
            $this->categoryid = $v;
            $this->modifiedColumns[CategoryTableMap::COL_CATEGORYID] = true;
        }

        if ($this->aCategorylist !== null && $this->aCategorylist->getId() !== $v) {
            $this->aCategorylist = null;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CategoryTableMap::translateFieldName('Teacherid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->teacherid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CategoryTableMap::translateFieldName('Organ', TableMap::TYPE_PHPNAME, $indexType)];
            $this->organ = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : CategoryTableMap::translateFieldName('Date', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : CategoryTableMap::translateFieldName('Num', TableMap::TYPE_PHPNAME, $indexType)];
            $this->num = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : CategoryTableMap::translateFieldName('Post', TableMap::TYPE_PHPNAME, $indexType)];
            $this->post = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : CategoryTableMap::translateFieldName('Place', TableMap::TYPE_PHPNAME, $indexType)];
            $this->place = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : CategoryTableMap::translateFieldName('Categoryid', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function ensureConsistency(): void
    {
        ...
        if ($this->aCategorylist !== null && $this->categoryid !== $this->aCategorylist->getId()) {
            $this->aCategorylist = null;
        }
    }
    ...
    protected function doSave(ConnectionInterface $con): int
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aCategorylist !== null) {
                if ($this->aCategorylist->isModified() || $this->aCategorylist->isNew()) {
                    $affectedRows += $this->aCategorylist->save($con);
                }
                $this->setCategorylist($this->aCategorylist);
            }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(CategoryTableMap::COL_TEACHERID)) {
            $modifiedColumns[':p' . $index++]  = 'teacherId';
        }
        if ($this->isColumnModified(CategoryTableMap::COL_ORGAN)) {
            $modifiedColumns[':p' . $index++]  = 'organ';
        }
        if ($this->isColumnModified(CategoryTableMap::COL_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'date';
        }
        if ($this->isColumnModified(CategoryTableMap::COL_NUM)) {
            $modifiedColumns[':p' . $index++]  = 'num';
        }
        if ($this->isColumnModified(CategoryTableMap::COL_POST)) {
            $modifiedColumns[':p' . $index++]  = 'post';
        }
        if ($this->isColumnModified(CategoryTableMap::COL_PLACE)) {
            $modifiedColumns[':p' . $index++]  = 'place';
        }
        if ($this->isColumnModified(CategoryTableMap::COL_CATEGORYID)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'teacherId':
                        ...
                        break;
                    case 'organ':
                        $stmt->bindValue($identifier, $this->organ, PDO::PARAM_STR);
    ...
    public function toArray(string $keyType = TableMap::TYPE_PHPNAME, bool $includeLazyLoadColumns = true, array $alreadyDumpedObjects = [], bool $includeForeignObjects = false): array
    {
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aCategorylist) {
                ...
                $result[$key] = $this->aCategorylist->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(CategoryTableMap::COL_TEACHERID)) {
            $criteria->add(CategoryTableMap::COL_TEACHERID, $this->teacherid);
        }
        if ($this->isColumnModified(CategoryTableMap::COL_ORGAN)) {
            $criteria->add(CategoryTableMap::COL_ORGAN, $this->organ);
        }
        if ($this->isColumnModified(CategoryTableMap::COL_DATE)) {
            $criteria->add(CategoryTableMap::COL_DATE, $this->date);
        }
        if ($this->isColumnModified(CategoryTableMap::COL_NUM)) {
            $criteria->add(CategoryTableMap::COL_NUM, $this->num);
        }
        if ($this->isColumnModified(CategoryTableMap::COL_POST)) {
            $criteria->add(CategoryTableMap::COL_POST, $this->post);
        }
        if ($this->isColumnModified(CategoryTableMap::COL_PLACE)) {
            $criteria->add(CategoryTableMap::COL_PLACE, $this->place);
        }
        if ($this->isColumnModified(CategoryTableMap::COL_CATEGORYID)) {
            $criteria->add(CategoryTableMap::COL_CATEGORYID, $this->categoryid);
        }
    ...
    public function copyInto(object $copyObj, bool $deepCopy = false, bool $makeNew = true): void
    {
        ...
        $copyObj->setOrgan($this->getOrgan());
    ...
    public function getTeacher(?ConnectionInterface $con = null)
    {
        if ($this->aTeacher === null && ($this->teacherid != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aTeacher->addCategories($this);
             */
        }
    ...
    /**
     * Declares an association between this object and a ChildCategorylist object.
     *
     * @param ChildCategorylist $v
     * @return $this The current object (for fluent API support)
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function setCategorylist(ChildCategorylist $v = null)
    {
        if ($v === null) {
        ...
        $this->aCategorylist = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the ChildCategorylist object, it will not be re-added.
        if ($v !== null) {
            $v->addCategory($this);
        }
    ...
    /**
     * Get the associated ChildCategorylist object
     *
     * @param ConnectionInterface $con Optional Connection object.
     * @return ChildCategorylist The associated ChildCategorylist object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function getCategorylist(?ConnectionInterface $con = null)
    {
        if ($this->aCategorylist === null && ($this->categoryid != 0)) {
            $this->aCategorylist = ChildCategorylistQuery::create()->findPk($this->categoryid, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCategorylist->addCategories($this);
             */
        }
    ...
    {
        if (null !== $this->aTeacher) {
            $this->aTeacher->removeCategory($this);
        }
        if (null !== $this->aCategorylist) {
            $this->aCategorylist->removeCategory($this);
        }
        $this->id = null;
        $this->teacherid = null;
        $this->organ = null;
