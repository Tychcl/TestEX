...
abstract class Eventawarddegree implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Models\\Map\\EventawarddegreeTableMap';
    ...
    /**
     * Initializes internal state of Models\Base\Eventawarddegree object.
     */
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Models\\Eventawarddegree'), 0, $e);
        }
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of \Models\Eventawarddegree (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Models\Eventawarddegree Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
