 ...
 *
 * @method     \Models\EventlevelQuery|\Models\EventQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class EventinfoQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Models\Base\EventinfoQuery object.
     *
     * @param string $dbName The database name
     * @param string $modelName The phpName of a model, e.g. 'Book'
     * @param string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Models\\Eventinfo', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \Models\Eventlevel object
     *
     * @param \Models\Eventlevel|ObjectCollection $eventlevel The related object(s) to use as filter
     * @param string|null $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($eventlevel instanceof \Models\Eventlevel) {
            return $this
            ...
            throw new PropelException('filterByEventlevel() only accepts arguments of type \Models\Eventlevel or Collection');
        }
    }
     ...
     *
     * @return \Models\EventlevelQuery A secondary query class using the current class as primary query
     */
    public function useEventlevelQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinEventlevel($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Eventlevel', '\Models\EventlevelQuery');
    }

    /**
     * Use the Eventlevel relation Eventlevel object
     *
     * @param callable(\Models\EventlevelQuery):\Models\EventlevelQuery $callable A function working on the related query
     *
     * @param string|null $relationAlias optional alias for the relation
     *
     * @param string|null $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     ...
     *
     * @return \Models\EventlevelQuery The inner query object of the EXISTS statement
     */
    public function useEventlevelExistsQuery($modelAlias = null, $queryClass = null, $typeOfExists = 'EXISTS')
    {
        /** @var $q \Models\EventlevelQuery */
     ...
     * @param string|null $queryClass Allows to use a custom query class for the exists query, like ExtendedBookQuery::class
     *
     * @return \Models\EventlevelQuery The inner query object of the NOT EXISTS statement
     */
     ...
     *
     * @return \Models\EventlevelQuery The inner query object of the IN statement
     */
     ...
     *
     * @return \Models\EventlevelQuery The inner query object of the NOT IN statement
     */
