...
abstract class Skill implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Models\\Map\\SkillTableMap';
    ...
    /**
     * Initializes internal state of Models\Base\Skill object.
     */
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Models\\Skill'), 0, $e);
        }
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of \Models\Skill (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Models\Skill Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
