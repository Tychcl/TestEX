...
abstract class Student implements ActiveRecordInterface
{
    ...
    public function setFio($v)
    {
        ...
        if ($this->fio !== $v) {
            $this->fio = $v;
            $this->modifiedColumns[StudentTableMap::COL_FIO] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : StudentTableMap::translateFieldName('Fio', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = StudentTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(StudentTableMap::COL_FIO)) {
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(StudentTableMap::COL_FIO)) {
            $criteria->add(StudentTableMap::COL_FIO, $this->fio);
        }
