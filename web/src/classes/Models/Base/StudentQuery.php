 ...
 * @method     ChildStudentQuery orderByFio($order = Criteria::ASC) Order by the fio column
 *
 * @method     ChildStudentQuery groupById() Group by the id column
 * @method     ChildStudentQuery groupByFio() Group by the fio column
 *
 ...
 * @method     ChildStudent|null findOneByFio(string $fio) Return the first ChildStudent filtered by the fio column
 *
 ...
 * @method     ChildStudent requireOneByFio(string $fio) Return the first ChildStudent filtered by the fio column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildStudent[]|Collection findByFio(string|array<string> $fio) Return ChildStudent objects filtered by the fio column
 * @psalm-method Collection&\Traversable<ChildStudent> findByFio(string|array<string> $fio) Return ChildStudent objects filtered by the fio column
 *
...
abstract class StudentQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id, fio FROM student WHERE id = :p0';
        try {
    ...
    public function filterByFio($fio = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(StudentTableMap::COL_FIO, $fio, $comparison);
