...
class StudentTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'Models.Map.StudentTableMap';
     ...
     */
    public const OM_CLASS = '\\Models\\Student';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'Models.Student';
     ...
     */
    public const COL_FIO = 'student.fio';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['Id', 'Fio', ],
        self::TYPE_CAMELNAME     => ['id', 'fio', ],
        self::TYPE_COLNAME       => [StudentTableMap::COL_ID, StudentTableMap::COL_FIO, ],
        self::TYPE_FIELDNAME     => ['id', 'fio', ],
        self::TYPE_NUM           => [0, 1, ]
    ];
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['Id' => 0, 'Fio' => 1, ],
        self::TYPE_CAMELNAME     => ['id' => 0, 'fio' => 1, ],
        self::TYPE_COLNAME       => [StudentTableMap::COL_ID => 0, StudentTableMap::COL_FIO => 1, ],
        self::TYPE_FIELDNAME     => ['id' => 0, 'fio' => 1, ],
        self::TYPE_NUM           => [0, 1, ]
    ];
    ...
    public function initialize(): void
    {
        ...
        $this->setClassName('\\Models\\Student');
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(StudentTableMap::COL_FIO);
        } else {
    ...
    public static function removeSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->removeSelectColumn(StudentTableMap::COL_FIO);
        } else {
     ...
     */
     public static function doDelete($values, ?ConnectionInterface $con = null): int
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Models\Student) { // it's a model object
