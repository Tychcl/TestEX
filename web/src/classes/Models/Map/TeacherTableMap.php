...
class TeacherTableMap extends TableMap
{
     ...
     */
    public const COL_FIO = 'teacher.fio';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['Id', 'Fio', 'Login', 'Password', 'Roleid', 'Needupdskill', 'Canupdcategory', ],
        self::TYPE_CAMELNAME     => ['id', 'fio', 'login', 'password', 'roleid', 'needupdskill', 'canupdcategory', ],
        self::TYPE_COLNAME       => [TeacherTableMap::COL_ID, TeacherTableMap::COL_FIO, TeacherTableMap::COL_LOGIN, TeacherTableMap::COL_PASSWORD, TeacherTableMap::COL_ROLEID, TeacherTableMap::COL_NEEDUPDSKILL, TeacherTableMap::COL_CANUPDCATEGORY, ],
        self::TYPE_FIELDNAME     => ['id', 'fio', 'login', 'password', 'roleId', 'needUpdSkill', 'canUpdCategory', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['Id' => 0, 'Fio' => 1, 'Login' => 2, 'Password' => 3, 'Roleid' => 4, 'Needupdskill' => 5, 'Canupdcategory' => 6, ],
        self::TYPE_CAMELNAME     => ['id' => 0, 'fio' => 1, 'login' => 2, 'password' => 3, 'roleid' => 4, 'needupdskill' => 5, 'canupdcategory' => 6, ],
        self::TYPE_COLNAME       => [TeacherTableMap::COL_ID => 0, TeacherTableMap::COL_FIO => 1, TeacherTableMap::COL_LOGIN => 2, TeacherTableMap::COL_PASSWORD => 3, TeacherTableMap::COL_ROLEID => 4, TeacherTableMap::COL_NEEDUPDSKILL => 5, TeacherTableMap::COL_CANUPDCATEGORY => 6, ],
        self::TYPE_FIELDNAME     => ['id' => 0, 'fio' => 1, 'login' => 2, 'password' => 3, 'roleId' => 4, 'needUpdSkill' => 5, 'canUpdCategory' => 6, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, 5, 6, ]
    ];
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(TeacherTableMap::COL_FIO);
            ...
            $criteria->addSelectColumn($alias . '.fio');
    ...
    public static function removeSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->removeSelectColumn(TeacherTableMap::COL_FIO);
            ...
            $criteria->removeSelectColumn($alias . '.fio');
